...
function ManagePam() {
  ...
  const { name, last_name, email, birth_date, archdiocese, archdiocese_id, zone_id, deanery_id } = useSelector((state) => state.pam);
  ...
  return (
    <div className="ManagePam">
      <Form onSubmit={handleSubmit}>
        ...
        <div>
        <Button className="ManageButtons" variant="danger" type="reset" onClick={handleCancel}> Cancelar
          </Button>
